...
//     Assertions.assertNotNull(user1.getId(), "ID-ul userului creat nu trebuie să fie null");
...
//     Assertions.assertNotNull(user2.getId(), "ID-ul userului creat nu trebuie să fie null");
// }
...
public class UserControllerIntegrationTest {
    ...
    public void cleanUpAndAddTestData() {
        ...
        user1 = userService.createUser(
                createUserRequest1.toUserDto(),
                createUserRequest1.getEmail(),
